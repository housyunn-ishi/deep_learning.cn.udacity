    ...
    with tf.Session() as sess:
        ...
        for epoch_i in range(epoch_count):
            for batch_images in get_batches(batch_size):
                ...
                _ = sess.run(g_train_opt, feed_dict={input_real: batch_images, input_z: batch_z, input_learning_rate: learning_rate})
                    
                if steps % 100 == 0 :
                    train_loss_d = d_loss.eval({input_real: batch_images, input_z: batch_z, input_learning_rate: learning_rate})
                    train_loss_g = g_loss.eval({input_real: batch_images, input_z: batch_z, input_learning_rate: learning_rate})
